...
const SheetOverlay = React.forwardRef<
  ...
  SheetOverlayProps
>(({ overlay = "black", className, ...props }, ref) => (
  ...
  "fixed z-50 gap-4 bg-background p-6 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        bottom:
          "py-10 px-0 inset-x-0 bottom-0 border-t data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
...
interface SheetContentProps
  ...
  overlay?: VariantProps<typeof overlayVariants>["overlay"];
}
